class Siege:
    ...
    def get_cargo_volume(self):
        # Leave empty for child classes to override
        pass
...
class BatteringRam(Siege):
    ...
    def get_trip_cost(self, distance, food_price):
        # Calculate the base trip cost using the parent method
        base_cost = super().get_trip_cost(distance, food_price)
        # Add the extra cost based on load weight
        return base_cost + (self.load_weight * 0.01)

    def get_cargo_volume(self):
        # Calculate the cargo volume of the battering ram
        return self.bed_area * 2  # Bed depth is 2 meters
...
class Catapult(Siege):
    ...
    def get_cargo_volume(self):
        # Return the cargo capacity of the catapult
