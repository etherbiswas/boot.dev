def file_to_prompt(file, to_string):
    # Convert the file dictionary into a string using the to_string function
    file_content = to_string(file)

    # Wrap the result in triple backticks with two newlines
    return f"```\n{file_content}\n```"
